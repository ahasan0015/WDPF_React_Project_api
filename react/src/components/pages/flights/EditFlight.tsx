...
function EditFlight() {
    ...
    const [departure_airports, setDeparture_airport] = useState([]);
    ...
    const [arrival_airports, setArrival_airport] = useState([]);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        api.put("edit-flight?id=" + id, flight)
        .then((res) => {
    ...
    return (
        ...
        <div className="container-xxl flex-grow-1 container-p-y">
          <h4 className="fw-bold py-3 mb-4">
            <Link to="/flights" className="text-muted fw-light">Flights /</Link> Edit
          </h4>
          <div className="card mt-3">
            <h5 className="card-header">Edit Flight</h5>
            <div className="card-body">
                <form onSubmit={handleSubmit}>
                    <div className="mb-3">
                        ...
                        onChange={(e) => setFlight({...flight, flight_id: parseInt(e.target.value)})}>
                            {
                                flights.map((item) =>
                    ...
                    <div className="mb-3">
                        ...
                        onChange={(e) => setFlight({...flight, airline_id: parseInt(e.target.value)})}>
                            {
                                airlines.map((item) =>
                                    <option value={item.id} key={item.id}>{item.name}</option>
                                )
                    ...
                    <div className="mb-3">
                        ...
                        <select name="departure_airport_id" className="form-select"
                        value={flight.departure_airport_id}
                        onChange={(e) => setFlight({...flight, departure_airport_id: parseInt(e.target.value)})}>
                            {
                    ...
                    <div className="mb-3">
                        ...
                        <select name="arrival_airport_id" className="form-select"
                        value={flight.arrival_airport_id}
                        onChange={(e) => setFlight({...flight, arrival_airport_id: parseInt(e.target.value)})}>
                            {
                    ...
                    <div className="mb-3">
                        ...
                        value={flight.flight_type_id}
                        onChange={(e) => setFlight({...flight, flight_type_id: parseInt(e.target.value)})}>
                            {
