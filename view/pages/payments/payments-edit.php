  ...
  <form method="post">
    <div class="card-body">
      ...
      <div class="form-group mb-3">
        ...
        <input type="text" class="form-control" name="payment_id" id="payment_id" value="<?php echo htmlspecialchars($res['payment_id']); ?>">
      </div>
      <div class="form-group mb-3">
      ...
      <div class="form-group mb-3">
        ...
        <input type="text" class="form-control" name="amount" id="amount" value="<?php echo htmlspecialchars($res['amount']); ?>">
      </div>
      <div class="form-group mb-3">
        <label for="payment_date">Payment Date</label>
        <input type="text" class="form-control" name="payment_date" id="payment_date" value="<?php echo htmlspecialchars($res['payment_date']); ?>">
      </div>
      <div class="form-group mb-3">
